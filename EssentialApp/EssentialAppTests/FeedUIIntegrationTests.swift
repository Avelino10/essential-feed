...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadMoreIndicator_isVisibleWhileLoadingMore() {
        ...
        sut.loadViewIfNeeded()
        XCTAssertFalse(sut.isShowingLoadMoreFeedIndicator, "Expected no indicator once view is loaded")
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url], "Expected on cancelled image URL request once first image is not visible anymore")
